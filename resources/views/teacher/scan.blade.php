<x-app-layout>
    ...
    <div class="min-h-screen bg-slate-50 dark:bg-gray-950">
        ...
        <div class="flex min-h-screen">
            ...
            <!-- SIDEBAR -->
            <aside
                class="hidden lg:flex w-64 flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800">
                ...
                <nav class="flex-1 p-4 space-y-2">
                    ...
                    <a href="{{ route('teacher.dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl
                    ...
                    <!-- Active -->
                    <a href="{{ route('teacher.scan') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl
            ...
            <main class="flex-1">
                ...
                <header class="h-20 bg-white dark:bg-gray-900
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('teacher.dashboard') }}" class="text-gray-500 hover:text-blue-600 transition">
                            ...
                            <div class="p-6 lg:p-10">
                                ...
                                <div class="max-w-lg mx-auto">
                                    ...
                                    <div class="mt-8 flex justify-center">
                                        ...
                                        <a href="{{ route('teacher.dashboard') }}" class="inline-flex items-center gap-2
                                              px-5 py-2.5
                                              rounded-xl
