...
<div class="flex items-center justify-between mt-4">
    ...
    <label for="remember_me" class="inline-flex items-center">
        <input
            id="remember_me"
            type="checkbox"
            class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-blue-600 shadow-sm focus:ring-blue-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800"
            name="remember"
        >
    ...
    @if (Route::has('password.request'))
        <a
            class="text-sm text-blue-600 hover:text-blue-700 hover:underline rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
